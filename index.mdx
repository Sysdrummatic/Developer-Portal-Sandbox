...
<Jumbotron>
  ...
  <Flex p={20} justifyContent="center">
    ...
    <Button variant="outlined" size="xlarge" to="developer-portal/interactive-tutorial.mdx">
      Interactive Tutorial Trial
    </Button>
    <Button variant="outlined" size="xlarge" to="developer-portal/step-by-step.mdx">
        Redocly Interactive Tutorial
    </Button>
  </Flex>
</Jumbotron>
<Box my={25}>
