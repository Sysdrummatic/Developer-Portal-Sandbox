...
<Jumbotron>
  ...
  <Flex p={20} justifyContent="center">
    ...
    <Button variant="outlined" size="xlarge" to="developer-portal/oAuth2-swagger.md">
      OAuth 2 - Swagger
    </Button>
    <Button variant="outlined" size="xlarge" to="developer-portal/oAuth2-cdq.md">
      OAuth 2 - CDQ
    </Button>
    <Button variant="outlined" size="xlarge" to="developer-portal/hide-internal.md">
      Hide Internal Swagger
    </Button>
  </Flex>
</Jumbotron>
<Box my={25}>
